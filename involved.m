function [N_players,in_idx] = involved()
%% count players 
...
I = [not(predict(CLASSIFIER_Plays,extractHOGFeatures(I1,'CellSize',[4 4]))) not(predict(CLASSIFIER_Plays,extractHOGFeatures(I2,'CellSize',[4 4]))) not(predict(CLASSIFIER_Plays,extractHOGFeatures(I3,'CellSize',[4 4])))];
in_idx = find(I==1);
